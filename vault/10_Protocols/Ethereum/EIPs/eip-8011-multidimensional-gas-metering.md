...
| 카테고리 | Core |
| 현재 상태 | Draft |
| 작성자 | Maria Silva (@misilva73), Davide Crapis (@dcrapis), Anders Elowsson (@anderselowsson), Toni Wahrstätter (@nerolation) |
| 생성일 | 2025-08-22 |
| 의존 EIP | [[EIP-1559]] |
| 원문 | [GitHub](https://github.com/ethereum/EIPs/blob/master/EIPS/eip-8011.md) |
