...
| 카테고리 | Core |
| 현재 상태 | Draft |
| 작성자 | Etan Kissling (@etan-status), Gajinder Singh (@g11tech), Matt Garnett (@lightclient), Vitalik Buterin (@vbuterin) |
| 생성일 | 2023-02-24 |
| 의존 EIP | [[EIP-6404]], [[EIP-6466]] |
| 원문 | [GitHub](https://github.com/ethereum/EIPs/blob/master/EIPS/eip-6493.md) |
