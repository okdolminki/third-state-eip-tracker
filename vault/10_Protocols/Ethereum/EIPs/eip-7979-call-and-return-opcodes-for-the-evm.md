...
| 카테고리 | Core |
| 현재 상태 | Draft |
| 작성자 | Greg Colvin (@gcolvin), Martin Holst Swende (@holiman), Brooklyn Zelenka (@expede), John Max Skaller <skaller@internode.on.net> |
| 생성일 | 2025-12-17 |
| 의존 EIP | [[EIP-3541]] |
| 원문 | [GitHub](https://github.com/ethereum/EIPs/blob/master/EIPS/eip-7979.md) |
