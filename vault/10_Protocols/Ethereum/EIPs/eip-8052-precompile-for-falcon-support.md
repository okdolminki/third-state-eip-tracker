...
| 카테고리 | Core |
| 현재 상태 | Draft |
| 작성자 | Renaud Dubois (@rdubois-crypto), Simon Masson (@simonmasson), Antonio Sanso (@asanso), Marius van der Wijden (@mariusvanderwijden), Kevaundray Wedderburn (@kevaundray), Zhenfei Zhang (@zhenfeizhang), Nicolas Consigny (@nconsigny) |
| 생성일 | 2025-10-17 |
| 의존 EIP | [[EIP-7932]] |
| 원문 | [GitHub](https://github.com/ethereum/EIPs/blob/master/EIPS/eip-8052.md) |
