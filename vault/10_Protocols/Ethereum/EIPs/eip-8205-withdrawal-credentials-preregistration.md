...
| 카테고리 | Core |
| 현재 상태 | Draft |
| 작성자 | George Avsetsin (@avsetsin), Dmitry Gusakov (@dgusakov), Greg Koumoutsos (@gkoumout), Eugene Mamin (@TheDZhon) |
| 생성일 | 2026-03-26 |
| 의존 EIP | [[EIP-4788]], [[EIP-6110]], [[EIP-7685]], [[EIP-7732]] |
| 원문 | [GitHub](https://github.com/ethereum/EIPs/blob/master/EIPS/eip-8205.md) |
