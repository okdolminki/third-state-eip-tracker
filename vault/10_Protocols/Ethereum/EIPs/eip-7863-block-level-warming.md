...
| 카테고리 | Core |
| 현재 상태 | Draft |
| 작성자 | Toni Wahrstätter (@nerolation), Jochem Brouwer (@jochem-brouwer), Alex Stokes (@ralexstokes), Ansgar Dietrichs (@adietrichs), Yoav Weiss (@yoavw), Alex Forshtat (@forshtat) |
| 생성일 | 2025-01-15 |
| 원문 | [GitHub](https://github.com/ethereum/EIPs/blob/master/EIPS/eip-7863.md) |
