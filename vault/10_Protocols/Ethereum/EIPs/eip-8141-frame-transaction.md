...
| 카테고리 | Core |
| 현재 상태 | Draft |
| 작성자 | Vitalik Buterin (@vbuterin), lightclient (@lightclient), Felix Lange (@fjl), Yoav Weiss (@yoavw), Alex Forshtat (@forshtat), Dror Tirosh (@drortirosh), Shahaf Nacson (@shahafn), Derek Chiang (@derekchiang) |
| 생성일 | 2026-01-29 |
| 의존 EIP | [[EIP-1559]], [[EIP-2718]], [[EIP-4844]], [[EIP-7997]] |
| 원문 | [GitHub](https://github.com/ethereum/EIPs/blob/master/EIPS/eip-8141.md) |
