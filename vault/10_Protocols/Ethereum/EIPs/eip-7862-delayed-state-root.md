...
| 카테고리 | Core |
| 현재 상태 | Draft |
| 작성자 | Charlie Noyes <charlie@paradigm.xyz>, Dan Robinson <dan@paradigm.xyz>, Justin Drake <justin@ethereum.org>, Toni Wahrstätter (@nerolation) |
| 생성일 | 2024-12-23 |
| 원문 | [GitHub](https://github.com/ethereum/EIPs/blob/master/EIPS/eip-7862.md) |
