...
| 카테고리 | ERC |
| 현재 상태 | Draft |
| 작성자 | Liu Zhicong (@waterflier), William Entriken (@fulldecent), Wei Qiushi (@weiqiushi), Si Changjun (@photosssa) |
| 생성일 | 2023-12-27 |
| 의존 EIP | [[EIP-165]], [[EIP-721]], [[EIP-1155]] |
| 원문 | [GitHub](https://github.com/ethereum/ERCs/blob/master/ERCS/erc-7585.md) |
