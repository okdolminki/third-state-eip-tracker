...
---
# ERC-7522: OIDC ZK Verifier for AA Account
...
| 카테고리 | ERC |
| 현재 상태 | Draft |
| 작성자 | Shu Dong (@dongshu2013) <shu@hexlink.io>, Yudao Yan <dean@dauth.network>, Song Z <s@misfit.id>, Kai Chen <kai@dauth.network> |
| 생성일 | 2023-09-20 |
| 의존 EIP | [[EIP-4337]] |
| 원문 | [GitHub](https://github.com/ethereum/ERCs/blob/master/ERCS/erc-7522.md) |
