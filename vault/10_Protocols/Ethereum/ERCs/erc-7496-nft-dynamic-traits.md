...
| 카테고리 | ERC |
| 현재 상태 | Draft |
| 작성자 | Adam Montgomery (@montasaurus), Ryan Ghods (@ryanio), 0age (@0age), James Wenzel (@emo-eth), Stephan Min (@stephankmin) |
| 생성일 | 2023-07-28 |
| 의존 EIP | [[EIP-165]], [[EIP-721]], [[EIP-1155]] |
| 원문 | [GitHub](https://github.com/ethereum/ERCs/blob/master/ERCS/erc-7496.md) |
