...
| 카테고리 | ERC |
| 현재 상태 | Draft |
| 작성자 | Vitalik Buterin (@vbuterin), Yoav Weiss (@yoavw), Dror Tirosh (@drortirosh), Shahaf Nacson (@shahafn), Alex Forshtat (@forshtat) |
| 생성일 | 2024-08-23 |
| 의존 EIP | [[EIP-155]], [[EIP-4337]], [[EIP-7562]] |
| 원문 | [GitHub](https://github.com/ethereum/ERCs/blob/master/ERCS/erc-7769.md) |
