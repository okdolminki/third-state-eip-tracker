...
| 카테고리 | ERC |
| 현재 상태 | Draft |
| 작성자 | Kieran Goodary (@IAmKio), Pillar Wallet (@pillarwallet), Luke Wickens (@lbw33), Rana Khoury (@RanaBug) |
| 생성일 | 2024-11-07 |
| 원문 | [GitHub](https://github.com/ethereum/ERCs/blob/master/ERCS/erc-7845.md) |
