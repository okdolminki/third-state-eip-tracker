...
| 카테고리 | ERC |
| 현재 상태 | Draft |
| 작성자 | Agustín Aguilar (@agusx1211), Michael Standen (@ScreamingHawk), Peter Kieltyka (@pkieltyka), William Hua (@attente), Philippe Castonguay (@PhABC) |
| 생성일 | 2024-10-22 |
| 의존 EIP | [[EIP-20]], [[EIP-721]], [[EIP-1155]], [[EIP-5792]] |
| 원문 | [GitHub](https://github.com/ethereum/ERCs/blob/master/ERCS/erc-7795.md) |
