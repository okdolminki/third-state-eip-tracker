...
---
# ERC-6787: Order Book DEX with Two Phase Withdrawal
...
| 카테고리 | ERC |
| 현재 상태 | Draft |
| 작성자 | Jessica (@qizheng09), Roy (@royshang), Jun (@SniperUsopp) |
| 생성일 | 2023-03-27 |
| 원문 | [GitHub](https://github.com/ethereum/ERCs/blob/master/ERCS/erc-6787.md) |
