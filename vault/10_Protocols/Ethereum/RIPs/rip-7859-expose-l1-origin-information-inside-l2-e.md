...
| 카테고리 | Core |
| 현재 상태 | Draft |
| 작성자 | Ian Norden (@i-norden), Bo Du (@notbdu), Christian Angelopoulos (@christianangelopoulos), Mark Tyneway (@tynes) |
| 생성일 | 2025-01-10 |
| 원문 | [GitHub](https://github.com/ethereum/RIPs/blob/master/RIPS/rip-7859.md) |
